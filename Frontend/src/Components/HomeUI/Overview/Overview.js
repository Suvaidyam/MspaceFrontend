  ...
  return (
    <>
      <div className="flex justify-center items-center flex-wrap  bg-white pb-8">
        ...
        <div className=" transform  transition duration-1000 hover:scale-105 hover:shadow-2xl      w-[270px] h-[250px]  m-3 ml-8   bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
          <a href="#">
