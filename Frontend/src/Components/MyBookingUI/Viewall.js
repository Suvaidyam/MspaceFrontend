...
const Viewall = () => {
  return (
    ...
    <div className=' flex'>
      ...
      <h1 className='px-6 flex font-bold text-lg'><span className='mr-4'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
